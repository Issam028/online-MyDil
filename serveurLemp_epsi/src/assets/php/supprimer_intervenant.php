...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    error_log("Message de PHP vers le journal des erreurs du serveur web");
    if ($id !== null) {
        try {
            ...
            echo json_encode(['status' => 'error', 'message' => 'Erreur lors de la suppression de l\'enseignant: ' . $e->getMessage()]);
        }
    } else {
        echo json_encode(['status' => 'error', 'message' => 'L\'ID de l\'enseignant � supprimer est manquant.']);
    }
} else {
